    ...
    <div className="animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-6">
        <div className="relative flex-1">
          <Search className="absolute left-3.5 top-1/2 -translate-y-1/2 transform text-slate-400 size-4" />
          <input
          ...
          <div
            ...
            <div className="flex items-center justify-between p-6 pb-0">
              <div>
                ...
                <p className="test-sm text-slate-500 mt-0.5">
                  Update employee details
                </p>
              </div>
              <button
                onClick={() => setEditEmployee(null)}
                className="p-2 rounded-lg hover:bg-stone-100 transition-colors text-slate-400 hover:text-slate-600">
                <X className="size-5" />
              </button>
            </div>
            <div className="p-6">
